...
if(id==='Home') id='list'
let norm=id.replace(/^\//,'').replace(/\/$/,'')
let file=norm
let tryFiles=[`docs/${file}.md`,`docs/${file}.mdx`,`docs/${file}/index.md`,`docs/${file}/index.mdx`]
let text=null
let found=''
...
contentEl.innerHTML=`<div class="notfound"><span class="badge">404</span><h2>Trang không tồn tại</h2><p style="color:var(--muted);font-weight:700">Không tìm thấy tài liệu “${id}”, có thể do sai liên kết hoặc tài liệu chưa được chuyển.</p><a class="btn btn-primary" href="#/list">Về trang chủ</a></div>`
